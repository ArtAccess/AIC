...
function getArt() {
    ...
    if (term) {
        ...
        if (country_var == 'Italy'){
          artistElement.innerHTML = "Michelangelo";
          titleElement.innerHTML = "Bacchus, 1496-97";
          imageLink.setAttribute('src', "https://www.theartstory.org/images20/works/michelangelo_1.jpg")
          document.getElementById("artwork-url").setAttribute('href', "https://www.theartstory.org/artist/michelangelo/artworks/");
        } else if (found_flowers) {
            artistElement.innerHTML = "Kurt Seligmann";
            titleElement.innerHTML = "Exotic garden, c. 1954";
            imageLink.setAttribute('src', "https://www.artic.edu/iiif/2/fef8bb75-6989-ad03-51b8-c8c7279bbc2a/full/800,/0/default.jpg")
            document.getElementById("artwork-url").setAttribute('href', "https://www.artic.edu/artworks/62315/exotic-garden");
